...
var ChatApp = function ChatApp() {
  ...
  _wsClient2.default.init("ws://localhost:3001"); // connection

  _wsClient2.default.registerOpenHandler(function () {
    _this.chatForm.onSubmit(function (data) {
      // on form submit, send msg to socket
...
var ChatMessage = function () {
  function ChatMessage(_ref) {
    var _ref$message = _ref.message,
        message = _ref$message === undefined ? "default" : _ref$message,
        _ref$user = _ref.user,
...
var ChatForm = function () {
  ...
  _createClass(ChatForm, [{
    key: "onSubmit",
    value: function onSubmit(submitCallBack) {
      var _this = this;
...
var ChatList = function () {
  function ChatList(listSel, username) {
    ...
    this.$list = (0, _jquery2.default)(listSel); // each instance is connected to a list
    this.username = username;
  }

  _createClass(ChatList, [{
    key: "drawMessage",
    value: function drawMessage(user) {
      var li2 = document.getElementById("chat_list").appendChild(document.createElement("li"));
...
exports.default = { init: init, registerOpenHandler: registerOpenHandler, registerMessageHandler: registerMessageHandler, sendMessage: sendMessage }; // literal object export
